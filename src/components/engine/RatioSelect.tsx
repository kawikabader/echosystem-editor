  ...
  return (
    <div className="flex items-center gap-3 group">
      ...
      <select
        ...
        className="flex-1 bg-surface-hover border border-border rounded px-2 py-1.5 text-xs text-text-primary outline-none focus:border-accent cursor-pointer appearance-none"
        style={{
